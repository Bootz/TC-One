...
MySQL - 5.5.9 : Database - ptr_gundrak_char
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ptr_gundrak_char` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `character_tutorial` (
  ...
  KEY `acc_key` (`account`)
) ENGINE=InnoDB AUTO_INCREMENT=16072 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Player System';
